            ...
            $.get(url, function(data, status) {
                if(status == 'success' && data != 'false') {
                    ...
                    if(val.sale_price_type1 != "0"){
                        var type1 = '<option value="' + val.sale_price_type1 + '">' + price(parseInt(val.sale_price_type1)) + ' GoFood </option>';
                    }
                    if(val.sale_price_type2 != "0"){
                        var type2 = '<option value="' + val.sale_price_type2 + '">' + price(parseInt(val.sale_price_type2)) + ' GrabFood</option>';
                    }
                    if(val.sale_price_type3 != "0") {
                        var type3 = '<option value="' + val.sale_price_type3 + '">' + price(parseInt(val.sale_price_type3)) + ' ShoppeFood</option>';
                    }
