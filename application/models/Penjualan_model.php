...
class Penjualan_model extends CI_Model {
	...
	function __construct(){
		...
		$this->select_default = 'sales_transaction.id AS id, customer_name, no_tablle, total_price, total_item,sales_transaction.date AS date,sales_transaction.pay_deadline_date,sales_transaction.is_cash';
	}
