      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('transaksi/create');?>">Tambah</a></li>
            <li role="presentation"><a href="<?php echo site_url('transaksi');?>">List</a></li>
          </ul>
		  <div class="box box-warning">
            ...
            <?php } ?>
              <div class="box-body">
                ...
                <div class="col-md-12">
                  <h3 class="content-title">List Produk</h3>
                    ...
                    <table class="table">
                      ...
                      <tbody id="transaksi-item">
                        <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-xs btn-warning" id="tambah-barang">Input Barang</a>
                          </td>
                        </tr>
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-danger" href="<?php echo site_url('transaksi');?>">Batal</a>
