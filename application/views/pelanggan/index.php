            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        <li role="presentation"><a href="<?php echo site_url('pelanggan/create');?>">Tambah</a></li>
                        <li role="presentation" class="active"><a href="<?php echo site_url('pelanggan');?>">List</a></li>
                    </ul>
                                ...
                                <?php if(isset($pelanggans) && is_array($pelanggans)){ ?>
                                    <?php foreach($pelanggans as $pelanggan){?>
                                        <tr>
                                            ...
                                            <td><?php echo $pelanggan->no_tablle;?></td>
                                            <td><?php echo $pelanggan->customer_address;?></td>
                                            <td>
                                                <a href="<?php echo site_url('pelanggan/edit').'/'.$pelanggan->id;?>" class="btn btn-xs btn-warning">Edit</a>
                                                <a onclick="return confirm('Are you sure you want to delete this pelanggan?');" href="<?php echo site_url('pelanggan/delete').'/'.$pelanggan->id;?>" class="btn btn-xs btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
