                ...
                <?php if(isset($tunggakans) && is_array($tunggakans)){ ?>
                  <?php foreach($tunggakans as $tunggakan){?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('tunggakan/detail').'/'.$tunggakan->id;?>" class="btn btn-xs btn-warning">Detail</a>
                        <a onclick="return confirm('Are you sure you want to delete this tunggakan?');" href="<?php echo site_url('tunggakan/delete').'/'.$tunggakan->id;?>" class="btn btn-xs btn-danger">Hapus</a>
                      </td>
                    </tr>
                  <?php } ?>
                <?php } ?>
