      ...
      <div class="row">
        <div class="col-xs-12">
            <ul class="nav nav-tabs">
                <li role="presentation"><a href="<?php echo site_url('supplier/create');?>">Tambah</a></li>
                <li role="presentation" class="active"><a href="<?php echo site_url('supplier');?>">List</a></li>
            </ul>
				...
				<?php if(isset($suppliers) && is_array($suppliers)){ ?>
				  <?php foreach($suppliers as $supplier){?>
					<tr>
					  ...
					  <td>
						<a href="<?php echo site_url('supplier/edit').'/'.$supplier->id;?>" class="btn btn-xs btn-warning">Edit</a>
						<a onclick="return confirm('Are you sure you want to delete this supplier?');" href="<?php echo site_url('supplier/delete').'/'.$supplier->id;?>" class="btn btn-xs btn-danger">Hapus</a>
					  </td>
					</tr>
				  <?php } ?>
				<?php } ?>
