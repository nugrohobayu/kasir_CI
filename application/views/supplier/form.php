      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('supplier/create');?>">Tambah</a></li>
            <li role="presentation"><a href="<?php echo site_url('supplier');?>">List</a></li>
          </ul>
            ...
            <?php } ?>
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($supplier) ? $supplier['supplier_name'] : '';?>" name="supplier_name" placeholder="Nama" id="name" class="form-control" required/>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($supplier) ? $supplier['supplier_phone'] : '';?>" name="supplier_phone" placeholder="Telepon" id="phone" class="form-control"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-danger" href="<?php echo site_url('supplier');?>">Batal</a>
