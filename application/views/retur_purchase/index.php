      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation"><a href="<?php echo site_url('retur_purchase/create');?>">Tambah</a></li>
            <li role="presentation" class="active"><a href="<?php echo site_url('retur_purchase');?>">List</a></li>
          </ul>
              ...
              <form action="<?php echo site_url('retur_purchase?search=true');?>" method="GET">
                ...
                <div class="box-body pad">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="submit">&nbsp</label>
                      <a href="<?php echo site_url('retur_purchase/export_csv');?>" class="form-control btn btn-success"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                    </div>
                  </div>
                </div>
              </form>
                  ...
                  <?php foreach($penjualans as $penjualan){?>
						<tr>
						  ...
						  <td>
							...
							<a target="_blank" href="<?php echo strpos($penjualan->sales_retur_id,'RETS') === false ? site_url('transaksi/detail') : site_url('retur_penjualan/detail');?>/<?php echo $penjualan->sales_retur_id;?>" class="btn btn-xs btn-warning">
							  detail
							</a>
						  </td>
						  ...
						  <td>
							...
							<?php if($penjualan->is_return == 0){?>
								<a href="<?php echo site_url('retur_purchase/edit').'/'.$penjualan->id;?>" class="btn btn-xs btn-default">Konfirmasi</a>
							<?php }else{ ?>
								<span class="btn-xs btn-success">Selesai</span>		
							<?php } ?>
							
							<a onclick="return confirm('Are you sure you want to delete this retur purchase?');" href="<?php echo site_url('retur_purchase/delete').'/'.$penjualan->id;?>" class="btn btn-xs btn-danger">Hapus</a>
						  </td>
						</tr>
                  <?php } ?>
                <?php } ?>
