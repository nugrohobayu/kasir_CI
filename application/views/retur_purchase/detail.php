                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Detail Retur Transaksi Pembelian <?php echo $details[0]->id;?></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('retur_purchase');?>" class="btn btn-sm btn-warning">Kembali</a></span>
								<?php if($details[0]->is_return == 0){?>
                                <span><a href="<?php echo site_url('retur_purchase/edit');?>/<?php echo $details[0]->id;?>" class="btn btn-sm btn-success">Konfirmasi</a></span>								
								<?php } ?>
                            </div>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo ($details[0]->is_return == 1) ? "Ya" : "Tidak";?></td>
